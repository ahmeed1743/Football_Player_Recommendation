...
function displayPlayers(filteredPlayers) {
    ...
    filteredPlayers.slice(startIndex, endIndex).forEach((player, index) => {
        ...
        const leagueLogoUrl = `Football_Player_Recommendation/assets/imgs/leagues/${encodeURIComponent(player.league.toLowerCase())}.png`;
        const teamLogoUrl = `Football_Player_Recommendation/assets/imgs/logos/${encodeURIComponent(player.team.toLowerCase())}.png`;
